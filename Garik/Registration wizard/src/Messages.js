const Messages = {
    generalInfo : {
        ...
        inputInfo : {
            ...
            password : {placeholder : 'Password ...', validEror : 'The password must contain minimum 8, maximum 16 characters and can not be empty'}
        }
    },
    packageInfo : {
        headInfo : {
    ...
    cardInfo : {
        ...
        inputInfo : {
            ...
            cardCvc : {placeholder : 'Credit Card cvc ...', validEror : "The Credit Card cvc must be 3 or 4 numbers and can not be empty"},
    ...
    respons : {
        headInfo : {
            step : 4,
            textHead : "Sending user information",
            iconHead : "fa fa-send"
        }
    }
};
